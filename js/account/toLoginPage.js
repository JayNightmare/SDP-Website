...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (event) {
        ...
        if (event.target.id === "race") {
            const otherRaceContainer = document.getElementById(
                "other-race-container",
            );
        ...
        if (event.target.id === "clinician-register-submit") {
            ...
            fetch(`${ENDPOINT}/auth/register`, {
                ...
                .then((data) => {
                    alert(
                        "Your registration is being reviewed. You will be notified when your account is approved.",
                    );
                    fetch(`../../js/account/html/practitioner.html`)
                        .then((response) => response.text())
                        .then((data) => {
        ...
        if (event.target && event.target.id === "patient-login") {
            ...
            fetch(`${ENDPOINT}/auth/login/patient`, {
                method: "POST",
                ...
                .then((data) => {
                    if (data.status === "success") {
                        ...
                        location.href =
                            "../../html/dashboard/patient-dashboard.html";
                    } else {
            ...
            event.target &&
            (event.target.id === "clinician-login" ||
                event.target.classList.contains("button_gl"))
        ) {
            ...
            fetch(`${ENDPOINT}/auth/login/clinician`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
